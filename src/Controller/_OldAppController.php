...
class OldAppController extends AbstractController
{
    ...
    /*
        TODO:
            ...
            - Add the rest of objects for other categories
    */
    ...
    */
    ...
    public function generator(): RedirectResponse
    {
        ...
        $generator_path = 'generator_files/';

        $vertical_street_png_path = $generator_path . 'graphics/strasse-vertikal.png';
        $horizontal_street_png_path = $generator_path . 'graphics/strasse-horizontal.png';
        $light_spot_png_path = $generator_path . 'graphics/spot.png';
        $red_light_png_path = $generator_path . 'graphics/licht_rot.png';
        $yellow_light_png_path = $generator_path . 'graphics/licht_gelb.png';
        $sun_png_path = $generator_path . 'graphics/sonne.png';
        $barrier_png_path = $generator_path . 'graphics/barrikade.png';
        ...
        */
        ...
        $sun_coordinate_y = rand(0, $tiles_amount_y - 2);
        ...
        /*
            ...
            -------------------------------
        */
        imagepng($img, $generator_path . 'rendered_image.png');

        // Free up memory
        imagedestroy($img);

        // Redirect to generated image
        return $this->redirect($generator_path . 'rendered_image.png');
    }
}
